...
module Make : functor (Spec : STM.Spec) ->
  sig
    ...
    val stress_prop_par : domain_mgr:[> Eio.Domain_manager.ty ] Eio.Resource.t -> Spec.cmd list * Spec.cmd list * Spec.cmd list -> bool
    ...
    val agree_prop_par : domain_mgr:[> Eio.Domain_manager.ty ] Eio.Resource.t -> Spec.cmd list * Spec.cmd list * Spec.cmd list -> bool
    ...
    val agree_prop_par_asym :  domain_mgr:[> Eio.Domain_manager.ty ] Eio.Resource.t ->  Spec.cmd list * Spec.cmd list * Spec.cmd list -> bool
    ...
    val agree_test_par :  domain_mgr:[> Eio.Domain_manager.ty ] Eio.Resource.t ->  count:int -> name:string -> QCheck.Test.t
    ...
    val neg_agree_test_par :  domain_mgr:[> Eio.Domain_manager.ty ] Eio.Resource.t -> count:int -> name:string -> QCheck.Test.t
    (** A negative parallel agreement test (for convenience). Accepts two labeled parameters:
        [count] is the number of test iterations and [name] is the printed test name. *)

    val agree_test_par_asym :  domain_mgr:[> Eio.Domain_manager.ty ] Eio.Resource.t -> count:int -> name:string -> QCheck.Test.t
    ...
    val neg_agree_test_par_asym :  domain_mgr:[> Eio.Domain_manager.ty ] Eio.Resource.t -> count:int -> name:string -> QCheck.Test.t
    (** A negative asymmetric parallel agreement test (for convenience).
        Accepts two labeled parameters:
        [count] is the number of test iterations and [name] is the printed test name. *)

    val stress_test_par :  domain_mgr:[> Eio.Domain_manager.ty ] Eio.Resource.t -> count:int -> name:string -> QCheck.Test.t
