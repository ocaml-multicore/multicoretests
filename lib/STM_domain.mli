...
module Make : functor (Spec : STM.Spec) ->
  sig
    ...
    val all_interleavings_ok : test_input -> bool
    ...
    val arb_triple : int -> int -> (Spec.state -> Spec.cmd QCheck.arbitrary) -> (Spec.state -> Spec.cmd QCheck.arbitrary) -> (Spec.state -> Spec.cmd QCheck.arbitrary) -> test_input QCheck.arbitrary
    ...
    val arb_triple_asym : int -> int -> (Spec.state -> Spec.cmd QCheck.arbitrary) -> (Spec.state -> Spec.cmd QCheck.arbitrary) -> (Spec.state -> Spec.cmd QCheck.arbitrary) -> test_input QCheck.arbitrary
    ...
    val agree_prop_par : test_input -> bool
    ...
    val agree_prop_par_asym : test_input -> bool
